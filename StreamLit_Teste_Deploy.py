 ...
 "cells": [
  ...
  },
  {
   ...
   "outputs": [
    {
     "ename": "SyntaxError",
     "evalue": "invalid syntax (1220473406.py, line 12)",
     "output_type": "error",
     "traceback": [
      "\u001b[1;36m  Cell \u001b[1;32mIn[4], line 12\u001b[1;36m\u001b[0m\n\u001b[1;33m    streamlit run C:\\Users\\Pedro.Seixas\\anaconda3\\Lib\\site-packages\\ipykernel_launcher.py\u001b[0m\n\u001b[1;37m              ^\u001b[0m\n\u001b[1;31mSyntaxError\u001b[0m\u001b[1;31m:\u001b[0m invalid syntax\n"
     ]
    }
   ],
   "source": [
    "st.set_page_config(page_title=\"Site do time mais brabo de tecnologia\")\n",
    "\n",
    "with st.container():\n",
    "    st.title(\"Equipe de tecnologia da vitrine direta\")\n",
